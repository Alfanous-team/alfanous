 ...
 * pyconfig.h
 *
 * Manually maintained version for Symbian OS.
 *
...
/*
 * Memory allocation functions for interpreter's own heap
 * in Symbian OS environment
 */
#define PyCore_MALLOC_FUNC      symport_malloc
#define PyCore_REALLOC_FUNC     symport_realloc
#define PyCore_FREE_FUNC        symport_free
#define NEED_TO_DECLARE_MALLOC_AND_FRIEND
// #define COUNT_ALLOCS 1
// #define Py_TRACE_REFS 1

/*
 * Use for Symbian OS specific code
 */
#define SYMBIAN

#ifndef HAVE_HUGE_VAL
...
/* Define if you want to use the DLC allocator */
...
#define DL_EXPORT(RTYPE) EXPORT_C RTYPE
#define DL_IMPORT(RTYPE) IMPORT_C RTYPE
