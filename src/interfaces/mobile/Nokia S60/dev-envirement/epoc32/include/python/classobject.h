...
typedef struct {
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyClass_Type, PyInstance_Type, PyMethod_Type; */

#define PyClass_Type ((PYTHON_GLOBALS->tobj).t_PyClass)
#define PyInstance_Type ((PYTHON_GLOBALS->tobj).t_PyInstance)
#define PyMethod_Type ((PYTHON_GLOBALS->tobj).t_PyMethod)
