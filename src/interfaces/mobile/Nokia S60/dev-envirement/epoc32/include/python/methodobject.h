...
extern "C" {
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyCFunction_Type; */

#define PyCFunction_Type ((PYTHON_GLOBALS->tobj).t_PyCFunction)
...
// XXX:CW32
extern DL_IMPORT(PyObject *) Py_FindMethod(const PyMethodDef[], PyObject *, char *);

// XXX:CW32
extern DL_IMPORT(PyObject *) PyCFunction_New(const PyMethodDef *, PyObject *);
