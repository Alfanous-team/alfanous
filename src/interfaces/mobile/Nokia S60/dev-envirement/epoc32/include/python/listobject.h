...
typedef struct {
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyList_Type; */

#define PyList_Type ((PYTHON_GLOBALS->tobj).t_PyList)
#define immutable_list_type ((PYTHON_GLOBALS->tobj).t_immutable_list_type)
