...
/* SYMBIAN note: currently code that wants to use this C API 
   on Symbian needs to be modified a bit as the static
   'PycStringIO' is not available. */ 
...
#else
#define PycString_IMPORT \
  (struct PycStringIO_CAPI*)xxxPyCObject_Import("cStringIO", "cStringIO_CAPI")
#endif
