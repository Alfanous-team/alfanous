...
#ifndef __E32DEF_H__
/* Both stdio.h and e32def.h define NULL in S60 SDK 1.2, which causes
   irritating compilation warnings. */
#undef NULL
#endif
#endif
#endif
...
typedef struct _longobject PyLongObject; /* Revealed in longintrepr.h */
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyLong_Type; */

#define PyLong_Type ((PYTHON_GLOBALS->tobj).t_PyLong)
