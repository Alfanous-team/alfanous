...
typedef struct {
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyFunction_Type; */

#define PyFunction_Type ((PYTHON_GLOBALS->tobj).t_PyFunction)
...
/* The classmethod and staticmethod types lives here, too */
  /* extern DL_IMPORT(const PyTypeObject) PyClassMethod_Type; */
  /* extern DL_IMPORT(const PyTypeObject) PyStaticMethod_Type; */

#define PyClassMethod_Type ((PYTHON_GLOBALS->tobj).t_PyClassMethod)
#define PyStaticMethod_Type ((PYTHON_GLOBALS->tobj).t_PyStaticMethod)
