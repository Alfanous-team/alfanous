...
typedef struct {
  ...
  /* extern DL_IMPORT(const PyTypeObject) PyInt_Type; */

#define PyInt_Type ((PYTHON_GLOBALS->tobj).t_PyInt)
...
*/
  ...
  /* extern DL_IMPORT(const PyIntObject) _Py_ZeroStruct, _Py_TrueStruct; *//* Don't use these directly */

#define Py_False ((PyObject *) &(PYTHON_GLOBALS->_Py_ZeroStruct))
#define Py_True ((PyObject *) &(PYTHON_GLOBALS->_Py_TrueStruct))
