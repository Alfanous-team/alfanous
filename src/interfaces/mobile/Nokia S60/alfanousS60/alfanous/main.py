...
@todo: SunnaSearchEngine,MedicamentsSearchEngine,AnimalsSearchEngine
@todo: Feedback System


@todo: relate the API with PyArabic
@todo: import  Qurany Corpus
@todo: relate with Elexir and PyArabic
...
if __name__ == '__main__':
    ...
    if QSE.OK:
        ...
        for key, value in QSE.suggest_all(string1).items():
            print key, ":", ",".join(value)
        print "\n#search#"   
        res, terms = QSE.search_all(string1, limit=6236, sortedby="mushaf",reverse=True)
        ...
        for num, respage in QPaginate(res, 5):
            html += "~~~~~page " + str(num) + "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
            for r in respage:
                html += "(" + str(r["aya_id"]) + "," + str(r["sura_id"]) + ") :" + u"<p>" + QSE.highlight(r["aya_"], values) + u"</p>\n"
            print html
            html = ""
