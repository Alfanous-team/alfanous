...
aspire to provide the benefits of facilitating the search for the user like
highlight,suggestions ...Etc..
...
to call the api from script
  ...
  - use the terms to highlight the aya text
            ...
            <span style="color:red;font-size:100.0%"><b>الْحَمْدُ</b></span>
            <span style="color:green;font-size:100.0%"><b>لِلَّـهِ</b></span>
 رَبِّ الْعَالَمِينَ
...
the API is divided to these main parties:
 - TextProcessing_ :
     contains the linguistic analysers of Quran and Arabic...etc.
 - QueryProcessing_ :
     contains specified query parsers , some linguistic operations and 
	suggestions systems
 - ResultsProcessing_ :
     contains the operations on the results (Scoring,Sorting,Pagination,
	extending,highlight)
 - Crawling_ :
     its a basic methode to find documents containing quran ayas.needed more 
	development
 - related_ :
     contains APIs used to import resources from related projects.these 
	projects are :
     - PyCorpus_ : to import  morphology xmlfile from quranic corpus project
     - PyTanzil_ : to import quran from tanzil project
     - PyAyaByAya_ : to connect the recitations on the site of VersePyVerse 
	project
