...
TASHKEEL = ( FATHATAN, DAMMATAN, KASRATAN,
            ...
            SUKUN,
            SHADDA,
            MADDA_ABOVE, HAMZA_ABOVE, HAMZA_BELOW,
            SUBSCRIPT_ALEF, INVERTED_DAMMA, NOON_GHUNNA, ZWARAKAY );
...
# regular expressions
HARAKAT_pattern = re.compile( r"[" + u"".join( HARAKAT ) + u"]" )
TASHKEEL_pattern = re.compile( r"[" + u"".join( TASHKEEL ) + u"]" )
HAMZAT_pattern = re.compile( r"[" + u"".join( HAMZAT ) + u"]" );
ALEFAT_pattern = re.compile( r"[" + u"".join( ALEFAT ) + u"]" );
LIGUATURES_pattern = re.compile( r"[" + u"".join( LIGUATURES ) + u"]" );