...
ARABIC_NAMES_FILE = ROOT_RESOURCE + "arabic_names.generated.json"
DERIVATIONS_FILE = ROOT_RESOURCE + "derivations.generated.json"
STANDARD_TO_UTHMANI_FILE = ROOT_RESOURCE + "standard_to_uthmani.generated.json"
STOP_WORDS_FILE = ROOT_RESOURCE + "stop_words.json"
SYNONYMS_FILE = ROOT_RESOURCE + "synonyms.json"
VOCALIZATIONS_FILE = ROOT_RESOURCE + "vocalizations.generated.json"
WORD_PROPS_FILE = ROOT_RESOURCE + "word_props.generated.json"
