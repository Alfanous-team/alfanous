...
current_version = information["version"] if "version" in information else 0.7
current_description = information["description"] if "description" in information else """ Alfanous is a search engine provide the simple and advanced search in the Holy Qur'an and more features.."""
current_lib_usage = information["lib_usage"] if "lib_usage" in information else "    $ sudo pip install alfanous"
