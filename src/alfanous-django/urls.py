...
urlpatterns = patterns('',
                       url(r'^robots.txt$',
                           TemplateView.as_view(template_name='protocols/robots.txt',
                                                content_type='text/plain')),
                       url(r'^opensearch.xml$',
                           TemplateView.as_view(template_name='protocols/opensearch.xml',
                                                content_type='application/opensearchdescription+xml')),
                       url(r'^sitemap.xml$',
                           TemplateView.as_view(template_name='protocols/sitemap.xml',
...
# Fall-back for non-supported languages from URL switch: xx-YY to xx to default (en)
urlpatterns += patterns('',
