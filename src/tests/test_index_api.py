...
def test_corpus_index_builds_without_unknown_field_error(corpus_qse_index):
    ...
    # englishcase, englishpos, englishmood, englishstate must NOT be in the schema
    # (englishmood/englishstate removed in favour of the Arabic mood/state fields;
    #  englishcase/englishpos were never in the schema)
