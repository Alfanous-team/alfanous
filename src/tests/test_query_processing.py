...
def test_parsing_with_schema():
    ...
    assert sorted(QP.parse(u">>سماكم").__dict__['words']) == [
        'أسماء', 'أسمائه', 'اسم', 'اسمه', 'الأسماء', 'السماء', 'السماوات',
        'بأسماء', 'باسم', 'بسم', 'تسمى', 'تسمية', 'سماء', 'سماوات', 'سموهم',
        'سميا', 'سميتموها', 'سميتها', 'ليسمون', 'مسمى', 'والسماء', 'والسماوات',
    ]
