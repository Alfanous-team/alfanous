...
def test_search_words_facets_lemma_and_type():
    """_search_words should return facets for lemma and type when requested."""
    result = RAWoutput._search_words({
        "query": "الله",
        "highlight": "none",
        "page": 1,
    ...
    # Both requested facet fields should appear
