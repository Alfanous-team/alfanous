...
def _tokenize_plain(analyzer, text):
...
def test_get_translation_analyzer_fallback_for_unsupported_language():
    ...
    tokens = _tokenize_plain(analyzer, "Hello World")
...
def test_english_stemming():
    ...
    tokens = _tokenize_plain(analyzer, "running")
    assert tokens == ["run"]
...
def test_french_stemming():
    ...
    tokens = _tokenize_plain(analyzer, "mangeant")
...
def test_german_stemming():
    ...
    tokens = _tokenize_plain(analyzer, "laufenden")
